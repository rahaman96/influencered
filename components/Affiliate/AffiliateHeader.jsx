                ...
                <div className="py-10 bg-gradient-to-b from-[rgb(90,145,77)] to-[#0F3D68] md:h-[367px]  h-[711px">
                    ...
                    <Wrapper>
                        <div className='md:mt-16 mt-5'>
                            <h6 className='text-[#FFFFFF] md:text-[64px] md:leading-[79px] font-bold md:w-[1100px] md:h-[142px] ' >Elevating Your Brand{'s'} Presence and Impact{'"'}</h6>
                        </div>
                    </Wrapper>
                </div>
            </header>
