                ...
                <Wrapper>
                    <div className='py-10'>
                        <div className="text-center">
                            ...
                            <p className='text-[#000000] opacity-70 md:text-[16px] md:leading-[24px] font-normal font-sans md:text-center text-left'>Help us curate the best media plan. The no of posts will be suggested based on the objective</p>
                        </div>
                        {/* card start */}
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10">
                            <div
                                className="md:w-[394px] border-l-[5px] border-b-[5px]  md:h-[293px] rounded-[10px] p-4 border-[#114067] border-[1px] bg-[#EDFFE9] ">
                                <div className='flex justify-between mb-2'>
                                    <TbBulb className='bg-white border-[1px] border-[#114067] rounded-full w-[75px] h-[75px] py-2 px-2 ' />
                                    <div className='mt-2'>
                                        <input id="helper-checkbox" aria-describedby="helper-checkbox-text" type="checkbox" value="" className="w-[31px] h-[31px] text-[#114067] bg-gray-100 border-gray-300 rounded focus:ring-[#114067] dark:focus:ring-[#114067] dark:ring-offset-gray-800 focus:ring-2 dark:bg-[#114067] dark:border-gray-600" />
                            ...
                            <div
                                className="hover:border-l-[5px] hover:border-b-[5px] md:w-[394px] md:h-[293px] rounded-[10px] p-4 border-[#114067] border-[1px] bg-[#EDFFE9] cursor-pointer ">
                                <div className='flex justify-between mb-2'>
                                    <TbBulb className='bg-white border-[1px] border-[#114067] rounded-full w-[75px] h-[75px] py-2 px-2 ' />
                                    <div className='mt-2'>
                            ...
                            <div
                                className="hover:border-l-[5px] hover:border-b-[5px] md:w-[394px] md:h-[293px] rounded-[10px] p-4 border-[#114067] border-[1px] bg-[#EDFFE9] ">
                                <div className='flex justify-between mb-2'>
                                    <TbBulb className='bg-white border-[1px] border-[#114067] rounded-full w-[75px] h-[75px] py-2 px-2 ' />
                                    <div className='mt-2'>
                                        <input id="helper-checkbox" aria-describedby="helper-checkbox-text" type="checkbox" value="" className="w-[31px] h-[31px] text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        ...
                        <div className='flex justify-center py-14 mb-16 ' onClick={() => router.push('presence')}>
