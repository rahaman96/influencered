...
import ElevatingHeader from '../HeaderComponents/ElevatingHeader'
                ...
                <Wrapper>
                    <div className="py-10 ">
                        <div className="text-center mb-10">
                            <h1 className='mb-5 text-[#000000] md:text-[36px] md:leading-[50px] font-medium font-sans '>Select your Interest and begin.</h1>
                        ...
                        <div
                            ...
                            <div className='mt-6'>
                                <h1 className='mb-2 text-[#000000] text-[30px] leading-[46px] font-medium font-sans h-[46px] '>Brand Awareness</h1>
                                <p className='mt-3 md:mb-12 text-[#000000] opacity-70 text-[14px] leading-[27px]  md:text-[25px] md:leading-[38px] font-medium font-sans md:w-[575px] md:h-[76px] '>Select this option if your campaign objective
                                    is to increase brand recognition</p>
                                <h5 className='md:mt-6 mt-2 text-[#000000] text-[20px] md:text-[27px] md:leading-[40px] font-medium font-sans h-[41px] '>Suggested deliverables</h5>

                                <div className="flex flex-wrap gap-2 md:mt-6 md:gap-6">
                        ...
                        <div className='flex justify-center py-14 mb-16 '>
