            ...
            <div className='md:p-4 md:px-16 md:mt-0 md:mb-0 mt-6 mb-4'>
                ...
                <div className="flex justify-between  md:pb-6 mt-4 md:mt-0">
                    <div className=''>
                        ...
                        <p className='md:w-[134px] md:h-[44px]  w-full font-medium text-[14px] leading-[18px] font-sans text-center px-16 md:px-0'>Collaborations</p>
                    </div>
                    <div>
                        <h6 className='text-[#000000] text-[30px] md:text-[53px] md:leading-[80px] px-4  md:w-[120px] md:h-[80px] text-center'>+100M</h6>
