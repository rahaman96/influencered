...
//                                     <div className='md:w-[420px] md:h-[126px] w-[422px] h-[123px]  '>
//                                         <h6 className={`md:text-[#000000] text-[#5A914D] text-[31px] leading-[47px] md:text-[32px] md:leading-[48px] h-[47px] font-medium font-sans md:border-b-[0px]  mb-3 ${styles.featuresSec} `}>
//                                             {/* <span className={`rounded-[5px ${styles.track}`}> */}
...
//                                     <div className='md:w-[420px] md:h-[126px] w-[422px] h-[123px] '>
//                                         <h6 className='text-[#000000] text-[23px] leading-[35px] md:text-[32px] md:leading-[48px] font-medium font-sans'>
//                                             Chat with your creators
//                                             {/* <img src="../image/border.svg" alt=""
//                                                 className='md:invisible visible w-[55px]'
//                                             /> */}
//                                         </h6>
...
//                                         <h6 className='text-[#000000] text-[23px] leading-[35px] md:text-[32px] md:leading-[48px] font-medium font-sans'>
//                                             Analyze performance
//                                             {/* <img src="../image/brandsness/ana.svg" alt=""
//                                                 className='md:invisible visible w-[45px] text-[40px]'
//                                             /> */}
...
//                                     </div>
//                                     <div className='md:w-[420px] md:h-[126px] w-[422px] h-[123px] '>
//                                         <h6 className='text-[#000000] text-[23px] leading-[35px] md:text-[32px] md:leading-[48px] font-medium font-sans'>Premium support</h6>
//                                         <p className='text-[#000000] opacity-70 text-[11px] leading-[18px] md:text-[16px] md:leading-[25px] '>
//                                             Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
//                                         </p>
//                                     </div>
...
//                             <img src="../image/brandsness/dashboard.svg" alt="card1" />
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
const FeaturesFor = () => {
    ...
    return (
        <div className='md:px-10 px-6'>
            {/* <Wrapper> */}
            <div className='md:w-[1240px] w-[422px]   w-[364px md:h-[708px]  h-[1128px h-ful rounded-[10px] z-10 '>
            <h6 className='flex gap-2 md:gap-4 text-[#000000] text-[30px] leading-[45px] md:text-[74px] md:leading-[105px] font-medium font-sans ' >
                     <span> Features </span>
                     <span className='md:text-[#000000] text-[#5A914D] '>for you</span>
                 </h6>
