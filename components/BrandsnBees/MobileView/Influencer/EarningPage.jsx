...
//                             </div>
//                         </div>
//                         <div className='md:w-[455px] md:h-[480px] md:-mt-[100px] mt-4'>
                    ...
                    <div className='px-4'>
                        {cardData.map((Text) => {
                            ...
                            return (
                                ...
                                >
                                    <h2>
                                        <button type="button" className="text-[23px] leading-[35px] md:text-[32px] md:leading-[48px] font-medium font-sans" style={{ color: active === Text.id ? '#FFFFFF' : '#114067' }}>
