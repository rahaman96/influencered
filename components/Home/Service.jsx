...
const Service = () => {
  return (
    <div className='py-5'>
      <Wrapper>
        <div>
          <h6 className='text-[#0F3D68] text-[45px] leading-[61px] font-bold font-sans '>Our Service</h6>
          <div>
            <section class="text-gray-600 body-font">
              <div class="container mx-auto flex  md:flex-row flex-col items-center">
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                  <Image class="object-cover object-center rounded" width={100} height={100} alt="hero" src="https://dummyimage.com/720x600" />
                </div>
              </div>
            </section>
          </div>
