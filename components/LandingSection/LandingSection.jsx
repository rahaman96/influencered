  ...
  return (
    <>
      <header className={`w-full  z-20  top-0 transition-transform duration-300 ${show}`}>
        <div className="py-10 bg-gradient-to-b from-[rgb(90,145,77)] to-[#0F3D68] md:h-[759px]  h-[660px]">
            ...
            <div>
              <div className="mx-aut flex py- md:flex-row flex-col">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-s">
                  <h1 className="mt-10 text-[35px] leading-[47px] md:text-[64px] md:leading-[79px] font-bold font-sans text-[#FFFFFF] md:w-[594px] md:h-[237px] ">
                    Elevating Your {"Brand's"} Presence and Impact
                  </h1>

                  <div className="mt-10" onClick={() => router.push('ecommerce/elevating')}>
                    <button className="w-[177px] h-[38px] md:w-[221px] md:h-[50px] border-[1px] border-[#FFFFFF] text-[#FFFFFF] text-[16px] leading-[20px] md:text-[20px] md:leading-[24px] font-medium font-sans ">
                      Start Now
                    </button>
                  </div>
                </div>
                ...
                <div className=' md:w-[591px] w-full mx-auto  ml-6 md:ml-0 -mt-20 md:-mt-0 '>
